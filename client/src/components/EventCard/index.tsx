			...
			<div className={style.card} onClick={() => setIsOpen(true)}>
				...
				<div className={style.cardBody}>
					...
					{currentUserId === event.authorId && (
						<div className={style.tileActions} onClick={(e) => e.stopPropagation()}>
							<Button variant="delete" onClick={() => onDelete(event.id)}>
								<svg
									width="20"
									height="20"
									viewBox="0 0 24 24"
				...
				<div className={style.overlay} onClick={() => setIsOpen(false)}>
					<div className={style.fullPage} onClick={(e) => e.stopPropagation()}>
						...
						<div className={style.hero}>
							<img src={event.image} alt={event.name} className={style.heroImage} />
								...
								<div className={style.gridBoxes}>
									<div className={style.box}>
										...
										<span className={style.boxValue}>
											{Number(event.price) === 0 || !event.price
												? 'Darmowe'
												: `${event.price} PLN`}
										</span>
									</div>
							...
							<section>
								...
								<div className={style.hostRow}>
									<img
										src={
											event.author?.photo ||
											`https://ui-avatars.com/api/?name=${event.author?.firstName}+${event.author?.lastName}`
										}
										alt="Host"
